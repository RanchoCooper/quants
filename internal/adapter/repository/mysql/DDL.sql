...
CREATE TABLE IF NOT EXISTS `quant_user` (
    ...
    `asset` DECIMAL(32, 6) NOT NULL DEFAULT '0.0' COMMENT 'asset',
    `profit` DECIMAL(32, 6) NOT NULL DEFAULT '0.0' COMMENT 'profit',
    `state` TINYINT(3) UNSIGNED DEFAULT '1' COMMENT 'state 0: default, 1: enable, 2: unable',
...
CREATE TABLE IF NOT EXISTS `quant_trade` (
    ...
    `type` TINYINT(3) UNSIGNED DEFAULT '0' COMMENT 'type 0: default, 1: buy, 2: sell',
    `price` DECIMAL(32, 6) NOT NULL DEFAULT '0.0' COMMENT 'price',
    `quantity` DECIMAL(32, 6) NOT NULL DEFAULT '0.0' COMMENT 'quantity',
