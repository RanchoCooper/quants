...
func (tkl *TickerKLine) GetTickerKLine(ctx context.Context, vo *TickerKLineQueryVO) []*TickerKLine {
    result := make([]*TickerKLine, 0)
    body := http.BinanceClient.GetTickerKLine(vo.Symbol, vo.Interval, vo.StartTime, vo.EndTime)
